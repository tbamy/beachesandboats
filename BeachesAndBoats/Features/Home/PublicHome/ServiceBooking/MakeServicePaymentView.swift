...
class MakeServicePaymentView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let amountToPay: Float = bookingDetail?.total ?? 0
    ...
    @IBAction func payTapped(_ sender: Any) {
        ...
        if let accessCode = paymentData?.accessCode{
