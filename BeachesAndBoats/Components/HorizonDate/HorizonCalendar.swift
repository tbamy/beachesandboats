    ...
    func setupCalendar() {
        ...
        calendarContent = calendarContent?.dayItemProvider { [weak self] day in
            ...
            let isValidDate = normalizedDate.map { normalizedDate in
                // Allow current day and future dates within the end date range
            ...
            else if self.isSingleDate && date == self.selectedDate {
        ...
        calendarView.daySelectionHandler = { [weak self] day in
            ...
            // First check: don't allow past dates (but allow today)
            ...
            if normalizedStartDate < today {
                ...
                guard normalizedSelected >= today && normalizedSelected <= normalizedEndDate else {
