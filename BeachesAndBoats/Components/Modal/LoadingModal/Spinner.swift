...
@IBDesignable class Spinner: UIView {
    ...
    func setup() {
        ...
        pathLayer.strokeColor = UIColor.beachBlue.withAlphaComponent(0.3).cgColor
        ...
        circleLayer.strokeColor = UIColor.beachBlue.cgColor
